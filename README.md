...
Como parámetros internos tiene unitats, t0 y t1. El parametro unitats almacena las unidades totales consumidas en la ectual ejecución del programa. Tanto t0 y t1 estan pensadas para controlar el tiempo des de la primera petición a la API, es decir cuando unitats=0, a la última petición a la API.  
